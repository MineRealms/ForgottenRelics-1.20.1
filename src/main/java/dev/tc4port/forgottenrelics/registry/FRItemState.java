...
public final class FRItemState {
    ...
    /** Dimensional Mirror stored position. */
    public static final ItemStateKey<net.minecraft.core.BlockPos> STORED_POS = new ItemStateKey<>(
            ForgottenRelics.id("stored_pos"), net.minecraft.core.BlockPos.CODEC);

    /** Dimensional Mirror stored dimension. */
    public static final ItemStateKey<net.minecraft.resources.ResourceLocation> STORED_DIMENSION = new ItemStateKey<>(
            ForgottenRelics.id("stored_dimension"), net.minecraft.resources.ResourceLocation.CODEC);
    ...
    public static void register(Object bus) {
        ItemStatePlatform.register(bus, java.util.List.of(
                ...
                ACTIVE, ABSORPTION, XP_STORED, DETECTED_POS, STORED_POS, STORED_DIMENSION));
    }
}
